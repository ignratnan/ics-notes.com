            ...
            <div class="mt-3 grid grid-cols-2">
                <div class="flex items-center">
                    ...
                    <div class="inline items-center my-3 mx-2 bg-black border rounded-md font-semibold text-xs">
                        <select v-model="sort" @change="sortCompanies" class="h-full px-3 py-2">
                            <option value="newest">Newest</option>
                            <option value="oldest">Oldest</option>
                            <option value="company_name_asc">A to Z</option>
                            <option value="company_name_desc">Z to A</option>
                        </select>
                    </div>
                </div>
